...
namespace WindowsFormsApplication1
{
    public partial class aar3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ans == "american revolution")
                {
                    using (System.IO.StreamWriter sw = new System.IO.StreamWriter(myFilePath, true))
                    {
                        sw.WriteLine(Environment.NewLine + "2." + strdisplay);
                    }
                    this.Hide();
                    aar4 ss = new aar4(countupseconds);
                    ss._timer = _timer1;
                    ss.ShowDialog();
                }
                else
