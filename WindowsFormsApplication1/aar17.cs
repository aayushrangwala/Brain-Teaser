    ...
    public partial class aar17 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (ans == "digitalisation")
                    {
                        using (System.IO.StreamWriter sw = new System.IO.StreamWriter(myFilePath, true))
                        {
                            sw.WriteLine(Environment.NewLine + "16." + strdisplay);
                        }
                        this.Hide();
                        aar18 ss = new aar18(countupseconds);
                        ss._timer = _timer1;
                        ss.ShowDialog();
                    }
                    else
