...
namespace WindowsFormsApplication1
{
    public partial class aar15 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ans == "A.P.J abdul kalam")
                {
                    using (System.IO.StreamWriter sw = new System.IO.StreamWriter(myFilePath, true))
                    {
                        sw.WriteLine(Environment.NewLine + "14." + strdisplay);
                    }
                    this.Hide();
                    aar16 ss = new aar16(countupseconds);
                    ss._timer = _timer1;
                    ss.ShowDialog();
                }
                else
