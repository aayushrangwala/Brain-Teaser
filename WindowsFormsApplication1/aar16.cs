...
namespace WindowsFormsApplication1
{
    public partial class aar16 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (ans == "emotional word")
                {
                    using (System.IO.StreamWriter sw = new System.IO.StreamWriter(myFilePath, true))
                    {
                        sw.WriteLine(Environment.NewLine + "15." + strdisplay);
                    }
                    this.Hide();
                    aar17 ss = new aar17(countupseconds);
                    ss._timer = _timer1;
                    ss.ShowDialog();
                }
                else
