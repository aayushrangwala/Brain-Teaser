...
{
    public partial class aar20 : Form
    {
        int countupseconds, minute, second,hour,milisec;
        String strmin, strsecond, strdisplay,strhr,strmsec;

        public aar20(int countupseconds)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (ans == "prakriti")
                {
                    ...
                    {
                        sw.WriteLine(Environment.NewLine + "19." + strdisplay + strmsec);
                    }
                    this.Hide();
                    aar21 ss = new aar21(countupseconds);
                    ss._timer = _timer1;
                    ss.ShowDialog();
                }
                else
